...
class AudiosControllerTest < ActionController::TestCase
  ...
  test "should create audio" do
    assert_difference('Audio.count') do
      post :create, audio: { description: @audio.description, sound: @audio.sound, title: @audio.title, user_id: @audio.user_id }
    end
  ...
  test "should update audio" do
    patch :update, id: @audio, audio: { description: @audio.description, sound: @audio.sound, title: @audio.title, user_id: @audio.user_id }
    assert_redirected_to audio_path(assigns(:audio))
  end
